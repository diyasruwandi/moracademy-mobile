...
class ApiEndpoints {
  ...
  static const String customBaseUrl = 'https://pretext-update-hatchling.ngrok-free.dev/api/v1';
  ...
  // Kosongkan string ( '' ) jika ingin menggunakan IP lokal di bawah
  static const String customQrBaseUrl = 'https://obstruct-hazing-panoramic.ngrok-free.dev/api';
